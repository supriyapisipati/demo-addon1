...
def load_sample_data() -> List[ComplianceViolation]:
    violations = []
...
def main():
    ...
    if mode == "Sample data":
        if st.sidebar.button("Load Sample Data"):
            violations = load_sample_data()
            metadata.title = "Compliance Report - Sample Data"
    else:
    ...
    if not violations:
        st.info("Select 'Sample data' and click 'Load Sample Data', or enter a Job ID to fetch violations.")
        return
